...
ScreenQuad::ScreenQuad()
{
	std::vector<Vertex>  vertices =
	{
		Vertex(+1, +1, 0, 0.f, 0.f, +1.f, 1.f, 1.f, 1.0, 0.0, 0.0),
		Vertex(-1, +1, 0, 0.f, 0.f, +1.f, 0.f, 1.f, 1.0, 0.0, 0.0),
		Vertex(-1, -1, 0, 0.f, 0.f, +1.f, 0.f, 0.f, 1.0, 0.0, 0.0),
		Vertex(+1, -1, 0, 0.f, 0.f, +1.f, 1.f, 0.f, 1.0, 0.0, 0.0),
	};
